...
/-- Type quantifiers: k_ex826873_ : Bool, width : Nat, width ∈ {1, 2, 4, 8} -/
...
/-- Type quantifiers: k_ex826887_ : Bool, k_ex826886_ : Bool, k_ex826885_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex826919_ : Bool, k_ex826918_ : Bool, k_ex826917_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex826966_ : Bool, k_ex826965_ : Bool, k_ex826964_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex826976_ : Bool, k_ex826975_ : Bool, k_ex826974_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
